    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
          ...
          <div>
            ...
            <div className="text-gray-500 mt-2">
              <p>
                ...
                Exercitationem ullam consectetur unde sit omnis numquam
                similique sequi? Ab ea amet delectus excepturi, debitis odio
                voluptates, quo, eaque numquam et quia?
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          <div className="shadow p-3 text-center my-5">
      ...
      <div>
        <div className="text-3xl font-semibold">Perk & Benefit</div>
        <div className="text-gray-500">
          This job comes with several perk and benefit
        </div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-gray-500">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Doloremque, deleniti odio. Vitae facilis voluptas reiciendis
                consectetur quos, fugiat fuga, iure fugit amet laborum ipsa
                possimus quod expedita ut id delectus!
              </div>
            </div>
          ))}
        </div>
